...
/**
 * The archive class serves as a logger for the kernel and processes. It has a few different levels such as info, warn, error, 
 * and debug.
 * 
 * @author Sugaku
 */
...
/**
 * A warp is a process that can be run. It contains some data about itself such as when it was registered and at what priority 
 * so that it can be ordered by the oracle. Additionally it has the room that registered it and its name so that the warp table 
 ...
 * @author Sugaku
 */
class WarpRegistry { // TODO: finish implementation.
